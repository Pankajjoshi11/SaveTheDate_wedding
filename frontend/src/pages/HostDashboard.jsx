...
const HostDashboard = () => {
  ...
  useEffect(() => {
    const fetchWeddings = async () => {
      try {
        const response = await fetch(`https://savethedate-wedding.onrender.com/api/hosts/${hostId}/weddings`);
  ...
  const handleApproveRequest = async (weddingId, userId) => {
    try {
      const response = await fetch(`https://savethedate-wedding.onrender.com/api/weddings/${weddingId}/approve`, {
        method: 'POST',
        headers: {
