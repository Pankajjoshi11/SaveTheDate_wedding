...
export default function EnhancedWeddingDetails() {
  ...
  const fetchWeddingDetails = async () => {
    try {
      const response = await fetch(`https://savethedate-wedding.onrender.com/api/weddings/${id}/`);
      console.log(id)
      if (!response.ok) {
  ...
  //     const response = await axios.patch(`https://savethedate-wedding.onrender.com/api/weddings/${id}`, {
  ...
  const handleRequestAccess = async (id, userId) => {
    try {
      const response = await fetch(`https://savethedate-wedding.onrender.com/api/weddings/${id}/request`, {
        method: 'POST',
        headers: {
